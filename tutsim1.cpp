...
static char const * robot_filename(TUTROB_XML_PATH_STR1);
...
namespace {
  ...
  static void raw_draw_tree(jspace::tao_tree_info_s & tree, double x0, double y0, double scale)
  {
    if (0 > id1) {
      ...
      id5 = find_node(*sim_tree, "link5")->getID();
      id6 = find_node(*sim_tree, "link6")->getID();
      id7 = find_node(*sim_tree, "link7")->getID();
      id8 = find_node(*sim_tree, "link8")->getID();
    }
    ...
    fl_line(x0 + (tree.info[id4].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id4].node->frameGlobal()->translation()[2] * scale),
	    x0 + (tree.info[id5].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id5].node->frameGlobal()->translation()[2] * scale));
    fl_line(x0 + (tree.info[id5].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id5].node->frameGlobal()->translation()[2] * scale),
	    x0 + (tree.info[id6].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id6].node->frameGlobal()->translation()[2] * scale));
    fl_line(x0 + (tree.info[id6].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id6].node->frameGlobal()->translation()[2] * scale),
	    x0 + (tree.info[id7].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id7].node->frameGlobal()->translation()[2] * scale));
   fl_line(x0 + (tree.info[id7].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id7].node->frameGlobal()->translation()[2] * scale),
	    x0 + (tree.info[id8].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id8].node->frameGlobal()->translation()[2] * scale));
    deFrame locframe;
    locframe.translation()[2] = -1.0;
    deFrame globframe;
    globframe.multiply(*(tree.info[id8].node->frameGlobal()), locframe);
    fl_line(x0 + (tree.info[id8].node->frameGlobal()->translation()[1] * scale),
	    y0 - (tree.info[id8].node->frameGlobal()->translation()[2] * scale),
  ...
  static void raw_draw_com(jspace::tao_tree_info_s & tree, double x0, double y0, double scale)
  {
    ...
    fl_point(x0 + (globpoint[1] * scale), y0 - (globpoint[2] * scale));
    globpoint.multiply(*(tree.info[id5].node->frameGlobal()), *(tree.info[id5].node->center()));
    fl_point(x0 + (globpoint[1] * scale), y0 - (globpoint[2] * scale));
    globpoint.multiply(*(tree.info[id6].node->frameGlobal()), *(tree.info[id6].node->center()));
    fl_point(x0 + (globpoint[1] * scale), y0 - (globpoint[2] * scale));
    globpoint.multiply(*(tree.info[id7].node->frameGlobal()), *(tree.info[id7].node->center()));
    fl_point(x0 + (globpoint[1] * scale), y0 - (globpoint[2] * scale));
    globpoint.multiply(*(tree.info[id8].node->frameGlobal()), *(tree.info[id8].node->center()));
    fl_point(x0 + (globpoint[1] * scale), y0 - (globpoint[2] * scale));
  }
		...
		double x0, double y0, double scale)
{
  ...
  scratchpos[id8] = jpos[id8];
  write_state_to_tree(&scratchpos, 0, *scratch_tree);
  deFrame locframe;
  locframe.translation()[2] = -1.0;
  deFrame globframe;
  globframe.multiply(*(scratch_tree->info[id8].node->frameGlobal()), locframe);
  fl_line(x0 + (scratch_tree->info[id8].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id8].node->frameGlobal()->translation()[2] * scale),
	  x0 + (globframe.translation()[1] * scale),
	  y0 - (globframe.translation()[2] * scale));
  
  scratchpos[id7] = jpos[id7];
  write_state_to_tree(&scratchpos, 0, *scratch_tree);
  fl_line(x0 + (scratch_tree->info[id7].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id7].node->frameGlobal()->translation()[2] * scale),
	  x0 + (scratch_tree->info[id8].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id8].node->frameGlobal()->translation()[2] * scale));
  
  scratchpos[id6] = jpos[id6];
  write_state_to_tree(&scratchpos, 0, *scratch_tree);
  fl_line(x0 + (scratch_tree->info[id6].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id6].node->frameGlobal()->translation()[2] * scale),
	  x0 + (scratch_tree->info[id7].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id7].node->frameGlobal()->translation()[2] * scale));
  
  scratchpos[id5] = jpos[id5];
  write_state_to_tree(&scratchpos, 0, *scratch_tree);
  fl_line(x0 + (scratch_tree->info[id5].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id5].node->frameGlobal()->translation()[2] * scale),
	  x0 + (scratch_tree->info[id6].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id6].node->frameGlobal()->translation()[2] * scale));  
  ...
  fl_line(x0 + (scratch_tree->info[id4].node->frameGlobal()->translation()[1] * scale),
	  ...
	  x0 + (scratch_tree->info[id5].node->frameGlobal()->translation()[1] * scale),
	  y0 - (scratch_tree->info[id5].node->frameGlobal()->translation()[2] * scale));  
